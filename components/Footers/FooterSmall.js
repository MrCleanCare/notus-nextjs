  ...
  return (
    <>
      <footer
        className={
          (props.absolute
            ? "absolute w-full bottom-0 bg-gradient-to-t from-blueGray-800 to-teal-700 dark:from-blueGray-900 dark:to-teal-800"
            : "relative bg-gradient-to-t from-blueGray-100 to-teal-50 dark:from-blueGray-900 dark:to-blueGray-800") +
          " pb-6 shadow-inner drop-shadow-md transition-all duration-300"
        }
        style={{ fontFamily: isRTL ? 'Cairo, sans-serif' : 'Segoe UI, sans-serif', direction: isRTL ? 'rtl' : 'ltr' }}
      >
        <div className="container mx-auto px-4">
          <hr className="mb-6 border-b-1 border-teal-200 dark:border-teal-700" />
